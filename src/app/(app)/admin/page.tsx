import { ClipboardList, MailWarning, ShieldCheck, Users, WalletCards } from "lucide-react";
    ...
    <div className="space-y-6">
      <div className="flex flex-col justify-between gap-4 sm:flex-row sm:items-center">
        <div>
          ...
          <h1 className="mt-1 text-3xl font-semibold tracking-normal">Console admin</h1>
          <p className="mt-2 text-sm text-muted-foreground">
            Connecte en tant que <span className="font-medium text-foreground">{user.email}</span>{" "}
      ...
      <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
        ...
        />
        <StatCard label="Portefeuilles" value={String(stats.portfolios)} icon={WalletCards} />
      </div>
